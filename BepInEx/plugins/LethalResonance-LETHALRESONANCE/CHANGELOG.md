### v4.7.8
- Fixed FacilityMeltdown compatibility
  - Separated Explosion from original file, so it now plays properly
- Updated SoundAPI Dependency to v2.0.4
...
### v4.7.6
- Hotfixed Metal Doors and Breaker Box Doors for compat with the latest release of EnemySoundFixes
- Fixed the Door Sounds on Adamance

If this breaks go shout at Lunxara
